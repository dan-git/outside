...
#include <opencv2/nonfree/features2d.hpp>  // needed for SURF
//#include <opencv2/features2d/features2d.hpp>
#include <opencv2/legacy/legacy.hpp> // needed for bruteforce matcher
...
class RobustMatcher {
  ...
  public:
          ...
          RobustMatcher() : ratio(0.65f), refineF(true), confidence(0.99), distance(3.0) {        
                  ...
                  // SURF is the default feature, but we generally use ORB
          ...
          cv::Mat match(cv::Mat& image1, cv::Mat& image2, // input images 
                ...
                // 1a. Detection of the ORB or SURF features
                detector->detect(image1,keypoints1);
                detector->detect(image2,keypoints2);

                std::cout << "Number of ORB or SURF points (1): " << keypoints1.size() << std::endl;
                std::cout << "Number of ORB or SURF points (2): " << keypoints2.size() << std::endl;

                // 1b. Extraction of the ORB or SURF descriptors
