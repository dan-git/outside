...
int main(int argc, char* argv[])
{
   ...
   // ***************************************************************
   camera_.open("PUT PATH TO VIDEO HERE");
   // ***************************************************************
...
// *************************************************************************************
// uncomment these two lines to see each frame drawn in the contour window.
// you will have to hit a key after each frame is displayed to move on to the next frame
