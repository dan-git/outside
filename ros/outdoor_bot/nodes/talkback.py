...
class TalkBack:
    def __init__(self, script_path):
        ...
        rospy.Subscriber('/play_wavfile', String, self.wavPlay)

        # Announce that we are ready for input
        self.soundhandle.playWave(self.wavepath + "/warcraft_alliance/readytoserve_peasant.wav")
        rospy.sleep(2)
    ...
    def wavPlay(self, msg):
        # Print the filename on the screen
        rospy.loginfo(msg.data)
        
        self.soundhandle.playWave(self.wavepath + msg.data)
        #provide some time for the wav file to play
        rospy.sleep(3)
